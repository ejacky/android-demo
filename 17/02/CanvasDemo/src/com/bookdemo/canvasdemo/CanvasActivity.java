package com.bookdemo.canvasdemo;
...
public class CanvasActivity extends Activity {
	...
	protected void saveBitmap() {
		try {
			...
			Toast.makeText(CanvasActivity.this, "保存图片成功", 0).show();
			...
			Toast.makeText(CanvasActivity.this, "保存图片失败", 0).show();
			e.printStackTrace();
		}
	}
	...
	protected void resumeCanvas() {
		...
		if (baseBitmap != null) {
			...
			canvas.drawColor(Color.WHITE);
			iv_canvas.setImageBitmap(baseBitmap);
			Toast.makeText(CanvasActivity.this, "清除画板成功，可以重新开始绘图", 0).show();
		}
	}
}
